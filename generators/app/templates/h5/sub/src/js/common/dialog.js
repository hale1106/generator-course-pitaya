...
var Loading = function(str){
  this.html = $('<div class="loading-con" style="width:200px;background:#701324;border:1px solid #e20731;border-radius:5px;padding:20px;"><div style="text-align:center;color:#fff">'+str+'</div></div>');
  this.dig = null;
};
